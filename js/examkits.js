function updateExamKits() {
  ...
  let dlRoot =
    "https://raw.githubusercontent.com/Academy-of-Learning-Career-College/exam-prep-files/main/";
  let suffix = "Practical_Exam_Kit.zip";

  let coursesArray = [
    { course: "WRD", courseName: "Word", ver: 19, level: [1, 2, 3] },
  ...
  if (typeof kit !== "undefined" && kit !== "") {
    lol = [
      coursesArray.find(function (obj) {
